# Nguồn của gói `javis.hermes-office`
...
|---|---|
| `docx` | `hermes-agent/skills/productivity/docx` |
| `xlsx` | `hermes-agent/skills/productivity/xlsx` |
| `powerpoint` | `hermes-agent/skills/productivity/powerpoint` |
| `pdf` | `hermes-agent/skills/productivity/pdf` |
| `document-to-action-items` | `hermes-agent/skills/productivity/document-to-action-items` |
| `meeting-action-items` | `hermes-agent/skills/productivity/meeting-action-items` |
