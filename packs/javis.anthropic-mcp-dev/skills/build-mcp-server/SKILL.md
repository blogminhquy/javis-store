...
description: "Build an MCP server that wraps an API: tools, resources, transports, testing."
group: "Claude · MCP dev"
version: 0.1.0
---
...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/plugins/mcp-server-dev/skills/build-mcp-server` - giấy phép Apache-2.0.*
