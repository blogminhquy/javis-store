---
name: "build-mcpb"
description: "Package an MCP server as an .mcpb bundle for one-click local install."
...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/plugins/mcp-server-dev/skills/build-mcpb` - giấy phép Apache-2.0.*
