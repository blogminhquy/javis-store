...
description: "Manage Telegram access: approve pairings, edit allowlists, set DM/group policy."
group: "Claude · Channels"
user-invocable: true
allowed-tools:
  - Read
  - Write
...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/external_plugins/telegram/skills/access` - giấy phép Apache-2.0.*
