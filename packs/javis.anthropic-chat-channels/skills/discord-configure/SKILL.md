...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/external_plugins/discord/skills/configure` - giấy phép Apache-2.0.*
