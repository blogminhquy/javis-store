...
description: "Check iMessage channel setup and review its access policy."
...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/external_plugins/imessage/skills/configure` - giấy phép Apache-2.0.*
