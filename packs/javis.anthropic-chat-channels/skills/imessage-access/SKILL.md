...
description: "Manage iMessage access: approve pairings, edit allowlists, set DM/group policy."
...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/external_plugins/imessage/skills/access` - giấy phép Apache-2.0.*
