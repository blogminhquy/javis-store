...
description: "Review a pull request correctness-first: lifecycle, security, broken required behavior."
group: "DeepSeek"
---
...
*Nguồn: [DeepSeek](https://github.com/deepseek-ai/deepseek-harness) - `deepseek-harness/.agents/skills/dsh-code-review` - giấy phép MIT.*
