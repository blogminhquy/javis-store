...
description: "Find code that can be deleted or collapsed without changing behavior."
group: "DeepSeek"
---
...
*Nguồn: [DeepSeek](https://github.com/deepseek-ai/deepseek-harness) - `deepseek-harness/.agents/skills/dsh-find-simplifications` - giấy phép MIT.*
