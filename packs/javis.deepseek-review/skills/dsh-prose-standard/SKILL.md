...
description: "Editorial standard for comments, docs, prompts and user-visible strings."
group: "DeepSeek"
---
...
*Nguồn: [DeepSeek](https://github.com/deepseek-ai/deepseek-harness) - `deepseek-harness/.agents/skills/dsh-prose-standard` - giấy phép MIT.*
