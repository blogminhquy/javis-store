...
description: "Security menu: scan a repo, a branch's changes, or one file for vulnerabilities."
group: "Claude · Setup"
...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/plugins/claude-security/skills/claude-security` - giấy phép Apache-2.0.*
