# Nguồn của gói `javis.hermes-research`
...
|---|---|
| `arxiv` | `hermes-agent/skills/research/arxiv` |
| `competitor-news-monitor` | `hermes-agent/skills/research/competitor-news-monitor` |
| `grounded-citations` | `hermes-agent/skills/research/grounded-citations` |
| `llm-wiki` | `hermes-agent/skills/research/llm-wiki` |
| `product-price-monitor` | `hermes-agent/skills/productivity/product-price-monitor` |
