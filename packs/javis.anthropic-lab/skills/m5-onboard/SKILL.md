---
name: "m5-onboard"
description: "Onboard a freshly plugged-in M5Stack ESP32 device: detect, flash, first app."
group: "Claude · Lab"
---
...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/plugins/cwc-makers/skills/m5-onboard` - giấy phép Apache-2.0.*
