---
name: "math-olympiad"
description: "Solve IMO/Putnam/USAMO problems with an adversarial verifier and calibrated confidence."
group: "Claude · Lab"
version: 0.1.0
---
...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/plugins/math-olympiad/skills/math-olympiad` - giấy phép Apache-2.0.*
