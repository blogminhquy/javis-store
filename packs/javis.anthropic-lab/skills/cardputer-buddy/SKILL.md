...
description: "Iterate on the Cardputer-Adv MicroPython app bundle after provisioning."
group: "Claude · Lab"
---
...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/plugins/cwc-makers/skills/cardputer-buddy` - giấy phép Apache-2.0.*
