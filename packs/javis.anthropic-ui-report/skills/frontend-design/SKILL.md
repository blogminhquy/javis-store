...
description: "Give new or reworked UI a deliberate visual direction instead of default styling."
...
*Nguồn: [Anthropic](https://github.com/anthropics/claude-plugins-official) - `claude-plugins-official/plugins/frontend-design/skills/frontend-design` - giấy phép Apache-2.0.*
